...
namespace abyssengine {
	std::vector<math::vec3> Shape::getVertices(Shape::shape shape)
	{
		std::vector<math::vec3> returnVector;

		switch (shape) {
		case Shape::BOX:
			returnVector.push_back(math::vec3(-0.5f, -0.5f, -0.5f));
			returnVector.push_back(math::vec3(-0.5f, 0.5f, -0.5f));
			returnVector.push_back(math::vec3(0.5f, 0.5f, -0.5f));
			returnVector.push_back(math::vec3(0.5f, -0.5f, -0.5f));
			returnVector.push_back(math::vec3(-0.5f, -0.5f, 0.5f));
		...
		case Shape::RECTANGLE:
			returnVector.push_back(math::vec3(-0.5f, -0.5f, 0.0f));
			returnVector.push_back(math::vec3(-0.5f, 0.5f, 0.0f));
			returnVector.push_back(math::vec3(0.5f, 0.5f, 0.0f));
			returnVector.push_back(math::vec3(0.5f, -0.5f, 0.0f));
			break;
